...
Last Edited: 10/30/2022 Online Version Avail: https://github.com/SparksTheFolf/CS-Fall22
...
while True:
    ...
    if "-yay" in remove or "-ay" in remove:  # Language Detector
        ...
        for words in ok:
            ...
            final+=" "
            bruh = str(final)
            hmm = bruh.replace("-", "").replace("yy", "y").replace("yare", "are").replace('yok', 'ok') # Remove the "y" and "-yay" and "yare" and "yy" and redo conversion
